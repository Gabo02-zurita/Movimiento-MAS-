...
def apply_custom_style():
    ...
    BACKGROUND_IMAGE_URL = "https://github.com/Gabo02-zurita/Movimiento-MAS-/blob/main/Gemini_Generated_Image_f3tielf3tielf3ti.png" # Usando un marcador de posición de engranajes
